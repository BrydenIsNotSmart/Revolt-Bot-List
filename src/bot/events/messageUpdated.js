...
module.exports = {
    ...
    async execute(message, nmsg) {
        if (nmsg.emoji_id === "🔔" && client.remind.get(message._id) && client.remind.get(message._id).owner === nmsg.user_id) {
            ...
            return message.reply(`<@${nmsg.user_id}>, I will remind you in 12 hours to vote for <@${mention[1]}>`);
        }
    },
};
